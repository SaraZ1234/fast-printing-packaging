        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7">
            <ClientAnimationWrapper type="fade-up" delay={0.15}>
              <div className="space-y-8 bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800 p-6 sm:p-10 rounded-3xl shadow-sm relative overflow-hidden">
