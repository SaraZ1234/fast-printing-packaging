...
const TRUST_ITEMS = [
  { icon: Truck, title: "Freight Integration", body: "LTL freight or localized daily carrier route setups directly handling regional fulfillment tracks seamlessly." },
  { icon: Scale, title: "Spectral Tolerances", body: "Strict delta-E verification testing metrics ensure exact reproduction fidelity across multiple shifts." },
  { icon: Maximize2, title: "Variable Scale Options", body: "Dynamic job layout optimization allows seamless routing from low-volume digital up to extreme offset runs." },
];

// Shared scroll-reveal so every section arrives the same considered way.
const fadeUp = {
...
export default function Home() {
  ...
  return (
    <main className="relative bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white pt-24 overflow-x-hidden antialiased">
      ...
      <section className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center justify-center py-16 sm:py-20 overflow-hidden border-b border-zinc-200/60 dark:border-zinc-900">
        <div className="absolute top-0 left-1/4 w-[500px] sm:w-[800px] h-[500px] sm:h-[800px] bg-gradient-to-tr from-indigo-500/10 to-transparent rounded-full blur-3xl animate-pulse pointer-events-none" />
        <div className="absolute bottom-10 right-1/4 w-[420px] sm:w-[700px] h-[420px] sm:h-[700px] bg-gradient-to-bl from-fuchsia-500/5 to-transparent rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-950/5 dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200 text-xs sm:text-sm font-bold tracking-wide border border-zinc-200 dark:border-zinc-800 backdrop-blur-sm">
              <Sparkles className="w-4 h-4 text-indigo-600 fill-indigo-600/10" /> Global Print Manufacturing & Packaging Engineering Hub
            </div>

            <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black tracking-tight leading-[1.05] sm:leading-[0.95] text-zinc-900 dark:text-white">
            ...
            <div className="pt-4 flex flex-col sm:flex-row justify-center items-center gap-4">
              <Link
                href="/quote"
                className="w-full sm:w-auto bg-indigo-600 text-white font-bold px-8 py-4 rounded-xl shadow-2xl shadow-indigo-600/30 hover:bg-indigo-700 hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2 group text-sm sm:text-base"
              >
                Initialize Production Spec Form <ArrowUpRight className="w-4 h-4 group-hover:rotate-45 transition-transform" />
              </Link>
              <Link
                href="/services"
                className="w-full sm:w-auto bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white font-bold px-8 py-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800/60 hover:-translate-y-0.5 active:translate-y-0 shadow-sm transition-all text-sm sm:text-base"
              >
                Explore Plant Capabilities
              </Link>
            </div>

            <div className="pt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs sm:text-sm font-semibold text-zinc-500 dark:text-zinc-400">
              <span className="inline-flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-indigo-600" /> G7 Master Certified</span>
              <span className="inline-flex items-center gap-1.5"><Award className="w-4 h-4 text-indigo-600" /> FSC Chain of Custody</span>
              <span className="inline-flex items-center gap-1.5"><Zap className="w-4 h-4 text-indigo-600" /> 3–5 Day Digital Turns</span>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-200/60 dark:border-zinc-900">
        <motion.div {...fadeUp} className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-4">
          ...
          {CORE_SERVICES.map((srv, i) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800 p-6 rounded-2xl shadow-sm flex flex-col justify-between hover:shadow-xl hover:-translate-y-1 hover:border-indigo-500/30 transition-all duration-300"
              >
      ...
      <section className="py-20 sm:py-24 bg-white dark:bg-zinc-900/20 border-b border-zinc-200/60 dark:border-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 sm:mb-16 gap-4">
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {EXTENDED_PRODUCTS.map((prod, i) => (
              <motion.div
                ...
                viewport={{ once: true, margin: "-80px" }}
                transition={{ duration: 0.5, delay: i * 0.08, ease: [0.22, 1, 0.36, 1] }}
                className="group bg-zinc-50 dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800 rounded-2xl overflow-hidden flex flex-col justify-between shadow-sm hover:shadow-lg transition-shadow duration-300"
              >
                ...
                <div className="p-5 space-y-4">
                  ...
                  <Link
                    ...
                    className="w-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-3 rounded-xl text-center text-sm font-bold text-zinc-800 dark:text-zinc-200 flex items-center justify-center gap-1.5 hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-600 transition-colors duration-200"
                  >
      ...
      <section className="py-20 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-200/60 dark:border-zinc-900">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 items-start">
          <motion.div {...fadeUp} className="lg:w-1/3 space-y-4 lg:sticky lg:top-32">
          ...
          <div className="lg:w-2/3 w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
            {MACHINERY_INVENTORY.map((mach, i) => (
              <motion.div
                ...
                viewport={{ once: true, margin: "-80px" }}
                transition={{ duration: 0.5, delay: i * 0.08, ease: [0.22, 1, 0.36, 1] }}
                className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-zinc-200/60 dark:border-zinc-800 shadow-sm space-y-3 hover:shadow-md hover:border-indigo-500/20 transition-all duration-300"
              >
      ...
      <section className="py-20 sm:py-24 bg-zinc-900 text-white border-b border-zinc-800 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div {...fadeUp} className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {SUBSTRATE_MATRIX.map((sub, idx) => (
              <motion.div
                ...
                className="bg-zinc-950/40 border border-zinc-800 p-6 rounded-xl space-y-4 flex flex-col justify-between hover:border-indigo-500/40 transition-colors duration-300"
              >
      ...
      <section className="py-20 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-200/60 dark:border-zinc-900">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
          <motion.div {...fadeUp} className="space-y-4 lg:sticky lg:top-32">
            <span className="text-xs font-mono font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400 flex items-center gap-1.5">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {INDUSTRIES.map((ind, i) => (
              <motion.div
                ...
                viewport={{ once: true, margin: "-80px" }}
                transition={{ duration: 0.5, delay: i * 0.08, ease: [0.22, 1, 0.36, 1] }}
                className="bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800 p-6 rounded-2xl shadow-sm flex flex-col justify-between hover:border-indigo-500/30 hover:shadow-md transition-all duration-300"
              >
                <div className="space-y-2">
      ...
      <section className="py-20 sm:py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-200/60 dark:border-zinc-900">
        <motion.div {...fadeUp} className="text-center space-y-2 mb-12 sm:mb-16">
        ...
        <div className="space-y-4">
          {FAQS.map((faq, i) => (
            <motion.div
              ...
              className="bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm"
            >
              <button
                onClick={() => setOpenFaq(openFaq === i ? null : i)}
                aria-expanded={openFaq === i}
                className="w-full text-left p-5 font-bold text-sm sm:text-base flex justify-between items-center gap-4 text-zinc-900 dark:text-white transition-colors duration-200 hover:bg-zinc-50 dark:hover:bg-zinc-800/40"
              >
                <span>{faq.q}</span>
              ...
              {openFaq === i && (
                <motion.div
                  ...
                  className="px-5 pb-5 text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium border-t border-zinc-100 dark:border-zinc-800/60 pt-4"
                >
                  {faq.a}
                </motion.div>
              )}
      ...
      <section className="py-16 sm:py-20 bg-zinc-100 dark:bg-zinc-900/30 border-b border-zinc-200/40 dark:border-zinc-900/40">
          ...
          {TRUST_ITEMS.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-sm sm:text-base text-zinc-900 dark:text-white mb-1.5">{item.title}</h4>
                  <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium">{item.body}</p>
                </div>
              </motion.div>
            );
          })}
      ...
      <section className="py-20 sm:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-80px" }}
          transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
          className="bg-gradient-to-b from-indigo-600 to-indigo-700 text-white p-8 sm:p-12 rounded-3xl shadow-2xl shadow-indigo-600/20 space-y-6 relative overflow-hidden"
        >
          ...
          <div className="pt-2">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-zinc-950 font-black px-8 py-4 rounded-xl text-sm sm:text-base shadow-xl hover:bg-zinc-50 hover:-translate-y-0.5 active:translate-y-0 transition-all group duration-200"
            >
